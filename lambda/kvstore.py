...
from utils import convert_date_to_epoch, get_current_datetime
...
class KVStore(object):
    ...
    def setup(self, name, key_type=KEY_TYPE, force_create=False, *args, **kwargs):
